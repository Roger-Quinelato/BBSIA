...
from catalogo_solucoes import OUTPUT_CHUNKS_FILE, materialize_solution_chunks  # noqa: E402
from embedding import run_embedding  # noqa: E402
...
def main() -> None:
    ...
    embedding_result = run_embedding(
        ...
        index_dir="data/solucoes_faiss_index",
    )
